...
public class UpdateStatusReportSystemUserCase
{
    ...
    public void TestUpdateStatus()
    {
        ...
        try
        {
            ...
            _driver.FindElement(By.Id("view-more")).Click();
            IWebElement reportDetailDiv = _driver.FindElement(By.Id("report-detail"));
            
            // Assert that the div exists
            Assert.That(reportDetailDiv, Is.Not.Null);
        }
